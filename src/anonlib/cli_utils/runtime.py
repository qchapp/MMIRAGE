"""Runtime/path helpers for the AnonLib CLI."""
...
def get_project_root(cfg: AnonLibConfig) -> str:
...
def validate_edf_env_path(cfg: AnonLibConfig) -> None:
...
def setup_runtime(cfg: AnonLibConfig, log_level: str) -> None:
