...
from anonlib.core.process.batch.registry import BatchAdapterFactory
from anonlib.core.process.processors.llm.config import LLMOutputVar, SGLangLLMConfig
    ...
    def __init__(self, engine_args: SGLangLLMConfig, **kwargs) -> None:
        ...
        if is_provider_batch_enabled:
            ...
            if not SGLANG_AVAILABLE:
                raise RuntimeError(
                    "SGLang is not installed. Install with: pip install 'anonlib[gpu]' "
