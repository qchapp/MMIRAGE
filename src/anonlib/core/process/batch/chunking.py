...
from anonlib.config.batch_provider import BatchProviderConfig, OversizedRequestPolicy
from anonlib.core.process.batch.adapter import BatchSubmissionAdapter
...
class BatchRequestChunker:
    ...
    def chunk_requests(self, requests: Sequence[Dict[str, Any]]) -> List[RequestChunk]:
