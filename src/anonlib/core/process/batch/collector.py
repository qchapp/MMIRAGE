...
from anonlib.core.process.batch.metadata_paths import resolve_metadata_paths_from_config
from anonlib.core.process.batch.metadata_utils import (
    BatchMetadataRecord,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    Reads receipt metadata, resolves provider configs from the supplied AnonLib
