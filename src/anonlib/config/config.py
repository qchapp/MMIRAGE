"""Configuration dataclasses for AnonLib pipeline."""

from dataclasses import dataclass, field
from typing import Any, Dict, List, Optional

from anonlib.config.loading import LoadingParams
from anonlib.core.process.base import BaseProcessorConfig
from anonlib.core.process.variables import InputVar, OutputVar


@dataclass
class ExecutionParams:
    """Parameters for executing the AnonLib pipeline.
    ...
    Attributes:
        ...
        job_name: SLURM job name. Defaults to "anonlib-sharded".
